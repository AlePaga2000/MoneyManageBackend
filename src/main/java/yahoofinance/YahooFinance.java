...
import yahoofinance.options.OptionsRequest;
...
import yahoofinance.search.Search;
...
public class YahooFinance {
    ...
    public static final String SEARCH_URL = System.getProperty("yahoofinance.baseurl.search", "https://query1.finance.yahoo.com/v1/finance/search");

    public static final String OPTIONS_BASE_URL = System.getProperty("yahoofinance.baseurl.options", "https://query2.finance.yahoo.com/v6/finance/options/");
    ...
    */
    ...
    public static Map<LocalDate,Map<OptionContract.OptionType, List<OptionContract>>>
        getOptionContracts(String symbol) throws IOException
    {
//        if(YahooFinance.QUOTES_QUERY1V7_ENABLED.equalsIgnoreCase("true")) {
//            throw new UnsupportedOperationException("Not yet implemented");
//        } else
        {
            OptionsRequest request = new OptionsRequest(symbol);
            return request.getResult();
        }
    }

    public static String luckySearchTicker(String query){
